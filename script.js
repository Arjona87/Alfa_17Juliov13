...
async function loadMunicipalBorders() {
    try {
        ...
        const municipiosAMG = [
            ...
            'Juanacatlan', 'Ixtlahuacán de los Membrillos', 'Zapotlanejo'
        ]; 
        ...
        const amgLayer = L.geoJSON(amgBorders, {
            style: function(feature) {
                const municipioName = feature.properties.NOMGEO || feature.properties.name || feature.properties.NOM_MUN;
                const municipiosConSombreado = ['Guadalajara', 'Zapopan', 'San Pedro Tlaquepaque','Tlajomulco de Zuñiga', 'Tonala', 'El Salto', 'Juanacatlan', 'Ixtlahuacán de los Membrillos', 'Zapotlanejo'];
